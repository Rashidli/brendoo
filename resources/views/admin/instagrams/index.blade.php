                                ...
                                <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row"><a class="btn btn-info" href="{{route('instagrams.show', $instagram->id)}}">Əlavə et</a></th>
                                            {{--                                                <td><img src="{{asset('storage/'.$instagram->image)}}" style="width: 100px; height: 50px" alt=""></td>--}}
                                            <td>
                                                <a href="{{route('instagrams.edit',$instagram->id)}}" class="btn btn-primary"
                                                   style="margin-right: 15px">Edit</a>
                                                <form action="{{route('instagrams.destroy', $instagram->id)}}" method="post" style="display: inline-block">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
